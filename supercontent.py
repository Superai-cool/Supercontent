...
Original file is located at
    https://colab.research.google.com/drive/1ABDD_uiORQgq1btejWg4BXEd0bGRFV9v
"""
    ...
    if tool == "LinkedIn Comment Creator":
        ...
        if st.button("Generate Comment"):
            if post_content.strip():
                def generate_linkedin_comment(api_key, post_content):
                    """
                    Generates a LinkedIn comment based on the provided post content.
                    ...
                    prompt = (
                        "Write a LinkedIn comment that is positive, engaging, and concise. Acknowledge the post meaningfully, add value with a relevant thought or question, and use a friendly, professional tone. Limit to 200 characters.\n"
                ...
                comment = generate_linkedin_comment(api_key, post_content)
        ...
        if st.button("Generate Post"):
            if content_topic.strip():
                def generate_viral_content(api_key, content_topic):
                    """
                    Generates a short, engaging, and viral LinkedIn post based on the provided topic or idea.
                    ...
                    prompt = (
                        "You are an expert LinkedIn post creator. Generate a short, engaging, and professional LinkedIn post based on the topic provided."
                ...
                post = generate_viral_content(api_key, content_topic)
